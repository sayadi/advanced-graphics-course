...
GLuint toonVertexShader, toonFragmentShader, toonShaderProgram;
GLuint toonPixelVertexShader, toonPixelFragmentShader, toonPixelShaderProgram;
...
void myDisplay(void)
{
	...
	if (perPixelLight)
	{
		glUseProgram(toonPixelShaderProgram);
		GLuint loc = glGetUniformLocation(toonPixelShaderProgram, "lPos");
	...
	else
	{
		...
		GLuint loc = glGetUniformLocation(toonShaderProgram, "lPos");
		glUniform3f(loc, lPos[0], lPos[1], lPos[2]);
...
int main(int argc, char** argv)
{
	...
	toonShaderProgram = setShaders("toon.vert", "toon.frag", toonVertexShader, toonFragmentShader);
	toonPixelShaderProgram = setShaders("toonPixel.vert", "toonPixel.frag", toonPixelVertexShader, toonPixelFragmentShader);
